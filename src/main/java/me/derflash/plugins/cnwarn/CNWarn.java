...
public class CNWarn extends JavaPlugin {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
    	...
    	if (label.equalsIgnoreCase("warn")) {
    		...
    		if (alenght == 1 && args[0].equalsIgnoreCase("list")) {
    			...
    			player1.sendMessage(ChatColor.AQUA + "/watch delete <name|ID> - Löscht den User aus der Beobachtungsliste");
                ...
                if (watchedUser == null) {
	    			...
	    			player1.sendMessage(ChatColor.AQUA + playerName + " erfolgreich zur Watchlist hinzugefügt!");
	...
	private void deleteWarning(Integer id, Player staffplayer) {
		...
		if (playerName != null) {
			...
			staffplayer.sendMessage("Verwarnung mit der ID " + id + " wurde gelöscht.");
		}
	}		
	...
	private void deleteWarnings(String playerName, Player staffplayer) {
		...
		staffplayer.sendMessage("Alle Verwarnungen von " + playerName + " wurden gelöscht.");
	}	
